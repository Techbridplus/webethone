...
const Dashboard = ({children}) => {
  return (
    (<div className="flex flex-1">
      <div
        className="  rounded-tl-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col flex-1 w-full h-full">
        {/* <div className="flex gap-2">
          {[...new Array(1)].map((i) => (
            <div
              key={"first-array" + i}
              className="h-20 w-full rounded-lg border-blue-700 border-2 bg-gray-100 dark:bg-neutral-800 animate-pulse">
                <FloatingDockDemo/>
              </div>
          ))}
        </div>
